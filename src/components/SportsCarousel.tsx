...
const SportsNav = () => {
  ...
  return (
    <div className="relative w-full p-4 bg-[#293339] text-white">
      ...
      <div ref={scrollRef} className="flex space-x-4 overflow-x-auto scroll-smooth px-10 hide-scrollbar">
        {sports.map((sport, index) => (
          <Link key={index} href={sport.link} className="flex flex-col items-center justify-center w-[90px]">
            ...
            <span
              className={`text-[0.6875rem] text-center mt-2 w-full transition ${
